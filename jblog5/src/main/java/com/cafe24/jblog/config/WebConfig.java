...
import com.cafe24.security.AuthBlogInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
	...
	@Bean
	public AuthBlogInterceptor authBlogInterceptor() {
		return new AuthBlogInterceptor();
	}
	@Bean
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry
		.addInterceptor(authBlogInterceptor())
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.addResourceHandler("assets/images/logo/**").addResourceLocations("file:/jblog-uploads/logo/");
	}
}